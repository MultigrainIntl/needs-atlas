...
Model-based CDC estimates put adult diabetes in Hunterdon County at 9.2% (New Jersey: 10.9%), obesity at 26.3% (NJ: 28.9%), and high blood pressure at 31.7% (NJ: 32.9%).[5] Hunterdon exceeds the statewide rate on 5 of the eleven tracked chronic conditions, including high cholesterol, coronary heart disease, and cancer (non-skin). 13.6% of adults report fair or poor overall health (NJ: 17.1%) and 13.3% report frequent mental distress (NJ: 14.7%). On health-related social needs, 4.6% of adults report a lack of reliable transportation and 7% report housing insecurity (NJ: 7.4% and 12.3%). These conditions define the day-to-day clinical demand a community health center must meet — and, paired with the coverage and language barriers documented above, the case for sustained primary, dental, and behavioral-health capacity. Birth outcomes reflect the same pressures: 6% of live births in Hunterdon County are low birthweight (New Jersey: 8%).[4]

## Food insecurity
An estimated 7.2% of Hunterdon County residents — about 9,380 people — live in food-insecure households, and 6.6% of the county's children face food insecurity.[6] Food insecurity compounds the barriers documented here: it tracks closely with low income and uninsurance and drives demand for the wraparound support Zufall's sites provide.
